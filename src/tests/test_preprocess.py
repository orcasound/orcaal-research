...
class TestPreprocess(unittest.TestCase):
    ...
    def test_extract_audio(self):
        ...
        data_test, sr_test = librosa.core.load("test_wav.wav", res_type="kaiser_best")
        data, sr = librosa.core.load("positive_calls/extracted_calls1.wav", res_type="kaiser_best", sr=22050)
    ...
    def test_apply_per_channel_energy_norm(self):
        ...
        data_test, sr_test = librosa.core.load("test_wav.wav", res_type="kaiser_best", sr=22050)
        data, sr = librosa.core.load("positive_calls/extracted_calls1.wav", res_type="kaiser_best", sr=22050)
    ...
    def test_wavelet_denoising(self):
        ...
        data, sr = librosa.core.load(
                   "positive_calls/extracted_calls1.wav",
